            ...
            <div>
                ...
                <div style="margin-top: 30px;">   
                 <p><label><button onclick="window.print();" target="_blank" class="btn btn-info" style="margin-left: 200px;"> print </button></label>  
                    <label><button onclick="location.href = 'SubAdminHome.php';" type="submit" class="btn btn-info" style="margin-left: 200px;"> back </button> </label>
