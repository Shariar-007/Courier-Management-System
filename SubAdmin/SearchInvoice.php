            ...
            <div class=" row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <br>
                        <p style="margin-left:10px;"> <a href="http://localhost:1234/Courier/SubAdmin/UpdateInvoice.php">List Data</a> | <a href="http://localhost:1234/Courier/SubAdmin/SearchInvoice.php">Search Data</a></p>
                        <hr>
