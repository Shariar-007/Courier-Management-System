                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div class="table-responsive"> 
                            <br>						
                            <label style="margin-left:10px;;">Start:</label><input type="datetime-local" name="start" style="width:200px; height:40px;">

                            <label>To	:</label> <input name="to" type="datetime-local" style="width:200px;height:40px;">								  
                            <br><br>	
                            <input type="submit" name="delete" value="Proses" style="width:60px;height:40px;margin-left:50px;">
                            <br><br>						  
                            <table class="table">
                                <thead>
                                    <tr>
