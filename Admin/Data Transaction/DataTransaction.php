                                ...
                                <tbody >					
                                            ...
                                            <tr>
                                                <form>
                                                    ...
                                                    <td><a href="EditData_Transaction.php?id=<?php echo $id ?>&date=<?php echo $date ?>&name=<?php echo $name ?>&destination=<?php echo $destination ?>&weight=<?php echo $weight ?>&totalcost=<?php echo $totalcost ?>&status=<?php echo $status ?>">Edit</a></td>                                                  
