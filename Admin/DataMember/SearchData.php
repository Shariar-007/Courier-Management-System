                    ...
                    <div class="panel panel-primary">
						...
						<div class="table-responsive">          
                              <form action="/action_page.php">
								 ...
								 <label style="margin-left:20px;">Search:</label> <input type="text" name="name" style="margin-left:100px; width:300px; height:40px;">
								</form><br>                          
							<input type="submit" name="delete" value="Search" style="width:60px;height:40px;margin-left:200px;">
							<br><br>
                        </div>
                    </div>
