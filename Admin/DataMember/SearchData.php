            ...
            <div class=" row">
                <div class="col-md-20 col-md-offset-0">
                    <div class="panel panel-primary">
                      ...
                      <div id="div2" style="margin-left: 1052px; color: #000000; font-family: sans-serif">
                                ...
                                <tbody >					
                                            ...
                                            <tr>
                                                <form>
                                                    ...
                                                    <input hidden="hidden" type="date" name="User_name" value="<?php echo $User_name ?>">
                                                    <input hidden="hidden" type="text" name="Password" value="<?php echo $Password ?>">
                                                    <input hidden="hidden" type="text" name="mail" value="<?php echo $mail ?>">
                                                    ...
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { echo $id ;}?></a></td>
                                                    
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { echo $User_name ;}?></td>
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { echo $Password ;}?></td>
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { echo $mail ;}?></td>
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { echo $Address ;} ?></td>
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { echo $Phone ;}?></td>
                                                    
                                                    <td><?php if(isset($_POST['Search'])&& !empty($_POST['name'])) { ?><a href="Edit_Searchable_Data.php?id=<?php echo $id; ?>&User_name=<?php echo $User_name; ?>&Password=<?php echo $Password; ?>&mail=<?php echo $mail; ?>&Address=<?php echo $Address; ?>&Phone=<?php echo $Phone ;?>">Edit</a><?php ;}?></td>                                                  
                                                </form>        
