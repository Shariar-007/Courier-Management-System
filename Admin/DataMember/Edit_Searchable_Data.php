<?php
if(isset($_GET['id']) && isset($_GET['User_name']) && isset($_GET['Password'])&& isset($_GET['mail']) && isset($_GET['Address'])&& isset($_GET['Phone'])) {
            ...
            <div class=" row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div style="margin-top:20px;"><p style="margin-left:10px;"> 
                            <p style="margin-left:20px;"><a href="DataBranch.php?go">List Data</a> | <a href="AddData.php">Add Data</a> | <a href="SearchData.php">Search Data</a></p>
                            <br>
                        <form action="DB_search_detail.php.php" method="post" style="margin-left: 20px;">						                       
                            <label >id:</label>
                            <input type="text" name="id" id="id"  value="<?php echo  $val1; ?>" readonly="true" style="margin-left:80px; width:300px; height:40px; border: 2px solid skyblue;">
                            <br><br>
                            <label >Name:</label>
                            <input type="text" name="name"  value="<?php echo  $val2; ?>"  style="margin-left:55px; width:300px; height:40px; border: 2px solid skyblue;">   
                            <br><br> 
                            <label >Password:</label>
                            <input type="text" name="password"  value="<?php echo  $val3; ?>"  style="margin-left:28px; width:300px; height:40px; border: 2px solid skyblue;">
                            <br><br>
                            <label >Email:</label>
                            <input type="text" name="email" value="<?php echo  $val4; ?>"  style="margin-left:57px; width:300px; height:40px; border: 2px solid skyblue;">   
                            <br><br>
                            <label >Address:</label>
                            <input type="text" name="address"  value="<?php echo  $val5; ?>"  style="margin-left:38px; width:300px; height:40px; border: 2px solid skyblue;">   
                            <br><br>
                            <label>Phone:</label>
                            <input type="text" name="phone"  value="<?php echo  $val6; ?>"  style="margin-left:50px; width:300px; height:40px; border: 2px solid skyblue;">   
                            <br>
