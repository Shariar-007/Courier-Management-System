<?php
if(isset($_GET['item']) && isset($_GET['id']) && isset($_GET['cost'])) {
    $item=$_GET["item"];
    $id=$_GET["id"];
    $costs=$_GET["cost"];
}else
...
if (mysqli_num_rows($result) > 0) {
    ...
    if($row["id"] == $id)
    {
         $val1=$row["ItemOfShipping"];
         $val2=$row["CostOfShipment"];
    }      
    }
} else {
    echo "0 results";
            ...
            <div class=" row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        <div class="panel-heading">SetUp Cost</div>
                        <br>
                        ...
                        <div class="table-responsive">
                            ...
                            <br>
                            <form action="DataMasterDatabase/ShippingEditComplete.php" method="post" style="margin-left: 20px;">						                       
                            <label style="margin-right: 94px;">Name:</label>
                            <input type="text" name="ShipName" id="ShipName"  value="<?php echo  $val1 ?>"  style="margin-left:100px; width:300px; height:40px;">
                            <br><br>
                            <label style="margin-right: 100px;">Cost:</label>
                            <input type="text" name="ShipCost" id="ShipCost" value="<?php echo  $val2 ?>"  style="margin-left:100px; width:300px; height:40px;">   
                            <input hidden="hidden" type="text" name="Id" id="Id" value="<?php echo  $id ?>"  style="margin-left:100px; width:300px; height:40px;">   
                            <br><br>
                            <input type="Submit" name="Edit" value="Edit" style="background-color:  skyblue; width:60px;height:40px;margin-left:240px;">
                            </form>
                            <br>
                        </div>
                    </div>
