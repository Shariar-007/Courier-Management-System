                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div class="table-responsive">
                            ...
                            <form action="DataMasterDatabase/editInsuranceValue.php" method="post" style="margin-left: 20px;">						                       
                            <label style="margin-right: 94px;">Insurance:</label>
                            <input type="text" name="insurance" value="<?php echo  $Insurance ?>"  style="margin-left:100px; width:300px; height:40px;">
                            ...
                            <a href="Insurance.php"><button style="width:60px;height:40px;margin-left:287px;margin-top: 20px;">Back</button></a>
                            <br><br>							                                                    							
