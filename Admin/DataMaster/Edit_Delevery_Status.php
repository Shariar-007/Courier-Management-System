<?php
if(isset($_GET['id']) && isset($_GET['track']) && isset($_GET['status'])) {
    $trackNo=$_GET["track"];
    $id=$_GET["id"];
    $Status=$_GET["status"];
}else
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div style="margin-top:20px;"><p><a href="Delevery Status.php" style="margin-left:20px;margin-top:10px; font-size:14px;">List Data </a> | <a href="addDataToDelevery.php" style="font-size:14px;margin-top:10px;"> Add Data</a></p></div>
                            <br>
                            <form action="DataMasterDatabase/Complete_Delevery_Status.php" method="post" style="margin-left: 20px;">						                       
                            <label style="margin-right: 89px;">Track Id:</label>
                            <input type="text" name="trackNo" id="trackNo"  value="<?php echo  $val1 ?>"  style="margin-left:100px; width:300px; height:40px;">
                            <br><br>
                            <label style="margin-right: 100px;">status:</label>
                            <input type="text" name="status" id="status" value="<?php echo  $val2 ?>"  style="margin-left:100px; width:300px; height:40px;">   
