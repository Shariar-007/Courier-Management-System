                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        ...
                        <div class="table-responsive">
                            ...
                            <form action="DataMasterDatabase/editTaxValue.php" method="post" style="margin-left: 20px;">						                       
                            <label style="margin-right: 94px;">Cost(%) :</label>
                            <input type="text" name="TAX" value="<?php echo  $TAX ?>"  style="margin-left:100px; width:300px; height:40px;">
                            ...
                            <a href="TAX.php"><button style="width:60px;height:40px;margin-left:287px;margin-top: 20px;">Back</button></a>
                            <br><br>							                                                    							
