            ...
            <div class=" row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Packing Costs </div>
                        <br>
             
                        <div class="table-responsive">

                            <form action="DataMasterDatabase/editPackingcost.php" method="post" style="margin-left: 20px;">						                       
                                <label style="margin-right: 94px;">Cost:</label><input type="text" name="cost" value=" <?php echo $value ?> " style="margin-left:100px; width:300px; height:40px;">
                                <br><br>
                                 <input type="submit" name="edit" value="Edit" style="width:60px;height:40px;margin-left:267px;">
                            </form>
                                 <a href="Packing.php"><button style="width:60px;height:40px;margin-left:287px;margin-top: 20px;">Back</button></a>
                            <br><br>							                                                    							
