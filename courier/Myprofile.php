...
<div class="row" >
    <div class="border1" style="width: 1000px; height: 100px;margin-left: 200px;">
        ...
        <form>
          <p style="margin-left: 20px;">With a mission to offer total logistics and courier services to corporates and many other business establishments, VITAL LINK INTERNATIONAL was established in the year 1985 in the city of DHAKA, BANGLADESH. We specialize in dealing in all sorts of International Express Courier, Chemical Shipment, Air Freight Service and Worldwide Service at industry leading prices.</p>
        </form>
      </div>
</div>
  <hr>
