    ...
    <div class="column">
        <div class="border1" style="border-style: groove;  margin-left: 180px;width: 1000px; height: 900px;">
            ...
            <div>
                ...
                <form action="database/DBForDetail.php"  method="post" style="margin-right: 600px; margin-top: 10px; transform-origin: left;">                   
                   ...
                   <input type="submit" value="Confirm" onclick="this.form.target='_blank';return true;" class="btn btn-info" style="margin-left: 50px;">
                    ...
                    <button onclick="location.href = 'Home.php';" class="btn btn-info" style="margin-top: 20px;margin-left: 30px;width: 90px;"> back </button></p>
