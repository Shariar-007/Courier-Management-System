...
<body>
  <nav class="navbar navbar-inverse">
    ...
    <div class="column2">
    <div class="border2" style=" border-style: groove; margin-left: 200px; width: 1000px; height: 200px;">
        ...
        <br>
            <button type="button" style="color: lightslategray; margin-left: 185px; width: 60px;height: 40px; font-size: 14px;">Check</button>
      </div>
  </div>
  <hr>
  <div>
